package cliente.hilo.Ejercicio2;
...
//En este ejemplo vamos a ver cómo podemos recoger dos números desde una aplicación
//cliente y mandárselos al sevidor para que nos devuelva una respuesta con 
...
public class SocketCliente1 {
	...
	public static void main(String[] args) {
		...
		//Usaremos la declaración try-with-resources, esta declaración nos asegura que
		//todos los objetos que declaremos e instanciemos dentro del bloque try, serán
		//cerrados cuando salgan del bloque try-catch. Es muy útil para ahorrarnos codigo
		...
		try (Scanner sc = new Scanner(System.in);
			...
			//Pedimos al usuario los números a sumar
			System.out.println("CLIENTE: Introduzca los numeros a sumar");
			String numero1 = sc.nextLine();//supongamos el numero 2025
			String numero2 = sc.nextLine();//supongamos el numero 2026
			
			//En este caso voy a establecer que mi comunicación entre el cliente y el
			//servidor va a ser que le mando los dos números separados por un "-"
			//para luego en el servidor obtener ambos números mediante el 
			//método split() de la clase String
			String operandos = numero1 + "-" + numero2;// 2025-2026
			
			//Obsérvese como no convierto los datos a enteros, ya que cuando
			//se mandan a través de un socket se mandan SIEMPRE en formato cadena
			...
			salida.println(operandos);//2025-2026
			
			//Creamos el objeto que nos va a permitir leer la salida del servidor
			InputStreamReader entrada = new InputStreamReader(socketAlServidor.getInputStream());
					
			//Esta clase nos ayuda a leer datos del servidor línea a línea en vez de 
			//carácter a carácter como la clase InputStreamReader
			BufferedReader bf = new BufferedReader(entrada);
			
			System.out.println("CLIENTE: Esperando al resultado del servidor...");
			//En la siguiente línea se va a quedar parado el hilo principal
			//de ejecución hasta que el servidor responda, es decir haga un println
			String resultado = bf.readLine();// suma total de 2025 + 2026 es 4051
				
			System.out.println("CLIENTE: El resultado de la suma es: " + resultado);// 4051

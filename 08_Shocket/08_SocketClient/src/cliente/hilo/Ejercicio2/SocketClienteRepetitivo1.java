...
//En este ejemplo vamos a ver como podemos recoger dos números desde una aplicación
//cliente y mandárselos al sevidor para que nos devuelva una respuesta con 
//el resultado de la suma de ambos. El programa seguirá mandando numeros al servidor
//hasta que el cliente decida parar el programa

//En este caso, cada petición que se haga al cliente sera independiente y se hará
//con un objeto socket diferente, es decir, simulamos abrir y cerrar comunicación
//por cada petición.
public class SocketClienteRepetitivo1 {

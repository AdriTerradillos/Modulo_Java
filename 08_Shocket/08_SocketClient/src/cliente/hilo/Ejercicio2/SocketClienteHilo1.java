...
//En este caso se usará una misma conexión para todo el intercambio de mensajes
//del cliente al servidor
public class SocketClienteHilo1 {
		...
		try (Scanner sc = new Scanner(System.in)){
			...
			do {
				...
				if("OK".equalsIgnoreCase(respuesta)) {
					...
					System.out.println("CLIENTE: Servidor responde, número de letras: " + respuesta);
				}				
			}while(continuar);

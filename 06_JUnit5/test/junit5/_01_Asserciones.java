...
class _01_Asserciones {
	...
	public void acabaEnMundoTest() {
		...
		//System.out.println(cadena.endsWith("mundo")); //este print devuelve true
	...
	//Tiempo máximo para que se ejecute el test (en ms)
	@Test
	...
	public void assertSameTest() throws InterruptedException{
		...
		Persona p1 = new Persona(); //instancia de un objeto Persona
		p1.setNombre("Tony");
		Persona p2 = new Persona(); //instancia de OTRO objeto Persona
		p2.setNombre("Tony");

package _02_herencias._05_casting;
...
public class MainCasting {
	...
	public static void main(String[] args) {
		...
		//Si hago la lista 
		//ArrayList<Docente> listaPersonas = new ArrayList<Docente>();
		//listaPersonas.add(a1);
		ArrayList<Persona> listaPersonas = new ArrayList<Persona>();
		listaPersonas.add(a1);
		listaPersonas.add(d1);
		
		//funcion lambda, funcion de un solo uso (p -> p.presentarse())
		//listaPersonas.forEach(p -> p.presentarse());
		//método por referencia :: indican la referencia Clase::metodo
		//listaPersonas.forEach(Persona::presentarse);
	...
	private static void metodoRecibirLista(ArrayList<Persona> listaPersonas) {
		...
		if(p1 instanceof Alumno) { //¿¿p1 es una instancia de la clase Alumno??

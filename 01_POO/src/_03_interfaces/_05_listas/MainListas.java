...
public class MainListas {
	...
	public static void main(String[] args) {
		...
		//En esta interfaz se define los métodos que tienen
		...
		//La implementación de ArrayList es una implementación
		...
		System.out.println(aCoche.getDato());
		System.out.println(aPersona.getDato());

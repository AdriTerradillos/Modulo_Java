package _04_excepciones._03_metodos;
...
public class _01_MetodosYExcepciones {
	public static void main(String[] args) {
		...
		int numero = 0;
		try { //Exception sin try-catch NO COMPILA
			numero = recogerNumeroExcepcion(); //throws Exception
		} catch (Exception e) {
		...
		//Las excepciones "unchecked" también podemos controlarlas con bloques
		//"try-catch" usando la opción de Eclipse -> Source -> surrounded with -> try-catch block
		
		try {
			int numero3 = recogerNumeroRuntimeException();
		} catch (RuntimeException e) {
			// TODO Auto-generated catch block
			//e.printStackTrace(); --> me da todos los detalles
			//System.err.println("No es correcto."); --> NO me da detalles.
		}
		...
		//importancia a la exepción y queremos obligar al programador

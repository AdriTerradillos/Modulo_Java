package _04_excepciones._01_basico;
...
public class _01_IntroduccionExcepciones {
	...
	public static void main(String[] args) {
		...
		try {
			s.charAt(0);
		} catch (NullPointerException npe) { // catch (Exception e) --> Exception genérica
			//Aquí ejecutamos las sentencias que queramos
			System.out.println("OJO! que te cojo! s está apuntado a NULL.");
		}
